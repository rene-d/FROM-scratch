 ...
 */
static gint CompareNames(gconstpointer name1, gconstpointer name2)
{
 ...
 * node.
 */
static gint TraverseTree(gpointer key, gpointer value, gpointer data)
{
    char *sKey = key;
    char *sValue = value;
...
int main_tree()
{
    ...
    g_tree_foreach(tree, TraverseTree, NULL);
}
